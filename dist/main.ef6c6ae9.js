...
function fetchAnimals(e) {
  ...
  // Fetch Pets
  (0, _fetchJsonp2.default)('http://api.petfinder.com/pet.find?format=json&key=12c87483d09b9a507b3a365ee9eb87ea&animal=' + animal + '&location=' + zip + '&callback=callback', {
    jsonpCallbackFunction: 'callback'
  }).then(function (res) {
    return res.json();
  }).then(function (data) {
...
},{"fetch-jsonp":10,"./validate":21}],6:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/main.ef6c6ae9.map